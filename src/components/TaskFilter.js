...
const TaskFilter = ({ filter, setFilter }) => {
  ...
  const filters = [
    { key: "all", label: "All", count: allCount, color: "#0d6efd" },       // Blue
    { key: "pending", label: "Pending", count: pendingCount, color: "#ffc107" }, // Yellow
    { key: "completed", label: "Completed", count: completedCount, color: "#198754" }, // Green
  ];
